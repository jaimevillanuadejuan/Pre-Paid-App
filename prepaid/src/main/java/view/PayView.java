...
public class PayView extends JDialog {
	...
	private static final long serialVersionUID = -4350720908397540377L;
	private PrePaidController controller;
	private JTextField cardNumberField;
	private JPasswordField pinField;
	private JTextField amountField;
	
	public PayView(PrePaidController controller) {
	...
	private void createBtnPanel() {
		...
		confirm.addActionListener(event -> this.controller.pay());
