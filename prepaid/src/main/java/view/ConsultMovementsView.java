...
public class ConsultMovementsView extends JDialog {
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 7917422292612106175L;
	PrePaidController controller;
	private JTextField cardNumberField;
	private JPasswordField pinField;
	
	public ConsultMovementsView(PrePaidController controller) {
...
JPanel panel = new JPanel();
	...
	private void createBtnPanel() {
		...
		confirm.addActionListener(event -> this.controller.consultMovements());
